        ...
        if (mCursor != null) {
            ...
            switch (x){
                ...
                case NotePad.Notes.ANTIQUE_WHITE_COLOR:
                    mText.setBackgroundColor(Color.rgb(250, 235, 215));
                    break;
                case NotePad.Notes.SKY_BLUE_COLOR:
                    mText.setBackgroundColor(Color.rgb(154,252,247));
                    break;
                ...
                case NotePad.Notes.GREEN_COLOR:
                    mText.setBackgroundColor(Color.rgb(162, 247, 218));
                    break;
                case NotePad.Notes.LIGHT_CORAL_COLOR:
                    mText.setBackgroundColor(Color.rgb(241, 167, 159));
                    break;
                default:
                    mText.setBackgroundColor(Color.rgb(255, 255, 255));
                    break;
